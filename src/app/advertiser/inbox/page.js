...
function AdvertiserInboxContent() {
        ...
        if (opportunityId && openChat === 'true') {
            if (conversations.length > 0) {
                ...
                if (conversation) {
                    ...
                    router.replace('/advertiser/inbox');
                } else {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            <div className="p-4 sm:p-8" style={{ marginLeft: 'var(--advertiser-sidebar-width, 80px)' }}>
                <motion.div
                    ...
                    <motion.div className="mb-8" variants={fadeDown}>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Manage your conversations with publishers</p>
                            </div>
                        </div>
                    </motion.div>
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    {searchTerm 
                                        ...
                                        : 'Start by making offers on opportunities to begin conversations with publishers'
                                    }
                                </p>
                            </motion.div>
                        ) : (
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div className="flex-shrink-0">
                                                <Image
                                                    ...
                                                    alt={conversation.participant?.firstName || 'Publisher'}
                                                    width={48}
                                                    height={48}
...
export default function AdvertiserInbox() {
    return (
