    ...
    return (
        <div className="min-h-screen bg-white text-black">
            ...
            <motion.section
                ...
                initial="hidden"
                animate="visible"
                className="relative px-4 sm:px-8 pt-6 sm:pt-8" style={{ marginLeft: 'var(--advertiser-sidebar-width, 80px)' }}
            >
            ...
            <motion.div className="px-4 sm:px-8 mt-6" style={{ marginLeft: 'var(--advertiser-sidebar-width, 80px)' }} variants={cardIn} initial="hidden" animate="visible">
            ...
            <motion.div className="px-4 sm:px-8 mt-6 pb-12" style={{ marginLeft: 'var(--advertiser-sidebar-width, 80px)' }} variants={cardIn} initial="hidden" animate="visible">
