...
export default function AdvertiserBookingsPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            <Sidebar />
            <div style={{ marginLeft: 'var(--advertiser-sidebar-width, 80px)' }}>
                <Header />
                ...
                <div className="relative overflow-hidden bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600">
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        >
                            ...
                            >
                                Manage your advertising bookings and track their progress
                            </motion.p>
                        </motion.div>
                    </div>
                </div>
                        ...
                        {Object.keys(statusCounts).length === 0 && (
                            ...
                            >
                                ...
                                <p className="text-gray-600 mb-4">
                                    Start by browsing opportunities and requesting bookings.
                                </p>
                                <motion.button
                            ...
                            >
                                ...
                                <p className="text-gray-600 mb-6">
                                    {filters.status || filters.search 
                                        ...
                                        : 'You don\'t have any advertising bookings yet.'
                                    }
                                </p>
                                {!filters.status && !filters.search && (
                                    <motion.button
