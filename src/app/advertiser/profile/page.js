        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 text-black">
            ...
            >
                ...
                >
                    <GlowOrbs />
                    <motion.div
                        className="relative bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600 rounded-3xl p-6 sm:p-8 text-white shadow-2xl"
                        variants={fadeDown}
                    >
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex-1">
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium bg-white/20 px-3 py-1 rounded-full backdrop-blur">
                                ...
                                <motion.p
                                    className="text-violet-100 text-sm sm:text-base max-w-2xl"
                                    variants={fadeDown}
                                >
                                    Manage your advertiser account, track campaigns, and connect with publishers to grow your brand presence.
                                </motion.p>
                            </div>
                            <motion.div
                                className="flex items-center gap-2 text-violet-100"
                                variants={fadeDown}
                            >
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    {/* Current Terms & Conditions Display */}
                    {user.termsAndConditions && (
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900">Current Brand Terms & Conditions</h2>
                                    <p className="text-sm text-gray-600">Your current brand guidelines and requirements</p>
                                </div>
                            </div>
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-gray-900">Business & Contact Information</h2>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-6">
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={6}
                                    placeholder="Describe your brand's terms and conditions, requirements, and guidelines for publishers..."
                                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-colors resize-none"
                                />
                                <p className="text-xs text-gray-600 mt-2">
                                    This information is shared with publishers to ensure they understand your brand guidelines and requirements.
                                </p>
                            </div>
