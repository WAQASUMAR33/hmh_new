...
const menuItems = [
    { name: 'Dashboard', icon: LayoutDashboard, path: '/advertiser' },
    { name: 'Opportunities', icon: Search, path: '/advertiser/opportunities' },
    { name: 'Publishers', icon: Users, path: '/advertiser/publishers' },
    { name: 'Bookings', icon: Calendar, path: '/advertiser/bookings' },
    { name: 'Inbox', icon: MessageSquare, path: '/advertiser/inbox' },
    { name: 'Profile', icon: User, path: '/advertiser/profile' },
