...
export default function Header({ title = "Admin Dashboard", icon: Icon = User }) {
    ...
    return (
        <motion.div
            ...
            className="relative flex justify-between items-center px-6 py-4 bg-gradient-to-r from-white via-violet-50/30 to-white sticky top-0 z-30 border-b border-violet-100/50 backdrop-blur-sm"
        >
            ...
            <div className="relative flex items-center gap-4">
                <div className="relative">
                    <div className="w-10 h-10 bg-gradient-to-br from-violet-500 via-purple-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/25">
                ...
                <div>
                    ...
                    <p className="text-sm text-violet-600/70 font-medium">Admin Portal</p>
                </div>
            </div>
            ...
            <div className="relative flex items-center gap-4">
                ...
                <div className="hidden md:block relative">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 w-64 bg-white/80 backdrop-blur-sm border border-violet-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-transparent transition-all duration-200 text-sm"
                        />
                    </div>
                </div>
                ...
                <div className="hidden lg:block text-right">
                    ...
                    <p className="text-sm font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
                        {userName}
                    </p>
                </div>
                    ...
                    >
                        <div className="relative">
                            <Image
                                ...
                                width={40}
                                height={40}
                                className="rounded-full border-3 border-violet-200 shadow-lg group-hover:border-violet-400 transition-all duration-200"
                            />
                    ...
                    <AnimatePresence>
                        {showProfile && (
                            <motion.div
                                ...
                                className="absolute right-0 mt-3 w-64 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-violet-100/50 z-40 overflow-hidden"
                            >
                                <div className="p-4 bg-gradient-to-r from-violet-50 to-purple-50 border-b border-violet-100/50">
                                ...
                                <ul className="py-2">
                                    <li className="px-4 py-3 hover:bg-violet-50/50 cursor-pointer flex items-center gap-3 transition-colors duration-200">
